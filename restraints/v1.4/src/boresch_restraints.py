...
prot_candidates = boresch_prot.select_protein_atoms(ref_complex_u, l1_coords)
...
candidate_triplets = boresch_prot.find_triplets(ref_complex_u, prot_candidates, l1_name, l2_name, l3_name, LIG_SEGID)
...
for lig_name in ligand_names[1:]:
    ...
    for ids in candidate_ids:
        ...
        if boresch_prot.conditions_met(complex_u, complex_lig_names, triplet, LIG_SEGID):
...
for i, lig_name in enumerate(ligand_names):
    ...
    equils = boresch_equils.compute_equils(complex_u, complex_lig_names, prots_final, LIG_SEGID)
